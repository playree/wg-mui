...
export const UserCircleIcon: React.FC<IconSvgProps> = ({ size = 24, strokeWidth = 2, ...props }) => (
  <svg
    fill='none'
    stroke='currentColor'
    viewBox='0 0 24 24'
...
export const Squares2x2Icon: React.FC<IconSvgProps> = ({ size = 24, strokeWidth = 2, ...props }) => (
  <svg
    fill='none'
    stroke='currentColor'
    viewBox='0 0 24 24'
...
export const UsersIcon: React.FC<IconSvgProps> = ({ size = 24, strokeWidth = 2, ...props }) => (
  <svg
    fill='none'
    stroke='currentColor'
    viewBox='0 0 24 24'
...
export const Cog6ToothIcon: React.FC<IconSvgProps> = ({ size = 24, strokeWidth = 2, ...props }) => (
  <svg
    fill='none'
    stroke='currentColor'
    viewBox='0 0 24 24'
