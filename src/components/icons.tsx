...
export const ArrowRightOnRectangleIcon: React.FC<IconSvgProps> = ({
  size = 24,
  strokeWidth = 2,
  width,
  height,
...
export const UserCircleIcon: React.FC<IconSvgProps> = ({ size = 24, strokeWidth = 2, width, height, ...props }) => (
  <svg
    fill='none'
    stroke='currentColor'
    viewBox='0 0 24 24'
