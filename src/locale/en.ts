...
export const en: LocaleItems = {
  ...
  item_dns_google: 'Google DNS',
  item_mtu: 'MTU',
  item_mtu_help: 'Set the MTU if communication is unstable.\nSpecify MTU -60, as confirmed on the following website.',
  item_download_conf_file: 'Download Config File',
  item_download_conf_file_dns: 'Download Config File (Use DNS specified by VPN)',
  item_download_conf_file_dns_google: 'Download Config File (Use Google DNS)',
  item_scan_qr: 'Scan from QR',
  item_scan_qr_dns: 'Scan from QR code (Use DNS specified by VPN)',
  item_scan_qr_dns_google: 'Scan from QR code (Use Google DNS)',
  item_close: 'Close',
  item_status: 'Status',
  item_from_ip: 'From',
