...
export const ja: DefaultLocaleItems = {
  ...
  item_dns_google: 'GoogleのDNS',
  item_mtu: 'MTU',
  item_mtu_help: '通信が安定しない場合にMTUを設定する\n下記サイトで確認したMTU -60を指定する',
  item_download_conf_file: '設定ファイルをダウンロード',
  item_download_conf_file_dns: '設定ファイルをダウンロード(VPNが指定するDNSを利用)',
  item_download_conf_file_dns_google: '設定ファイルをダウンロード(Google DNSを利用)',
  item_scan_qr: 'QRコードをスキャン',
  item_scan_qr_dns: 'QRコードをスキャン(VPNが指定するDNSを利用)',
  item_scan_qr_dns_google: 'QRコードをスキャン(Google DNSを利用)',
  item_close: '閉じる',
  item_status: 'ステータス',
  item_from_ip: '接続元',
  item_transfer: '転送量',
  ...
  msg_created: '${item} を作成しました',
  msg_updated: '${item} を更新しました',
  msg_deleted: '${item} を削除しました',
