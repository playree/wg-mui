...
export const zEmail = z.email(el('@invalid_email')).or(zEmpty).transform(convNull)
export const zEmailChange = z.email(el('@invalid_email'))
...
export const zEndPoint = z.url(el('@invalid_end_point'))
...
export type UpdateUserIn = z.input<typeof scUpdateUser>
export type UpdateUserOut = z.output<typeof scUpdateUser>
...
export type InitializeWgConfIn = z.input<typeof scInitializeWgConf>
export type InitializeWgConfOut = z.output<typeof scInitializeWgConf>
...
export type WgConfPostScriptIn = z.input<typeof scWgConfPostScript>
export type WgConfPostScriptOut = z.output<typeof scWgConfPostScript>
...
export type WgConfForClientsIn = z.input<typeof scWgConfForClients>
export type WgConfForClientsOut = z.output<typeof scWgConfForClients>
...
export type CreatePeerIn = z.input<typeof scCreatePeer>
export type CreatePeerOut = z.output<typeof scCreatePeer>
...
export type UpdatePeerIn = z.input<typeof scUpdatePeer>
export type UpdatePeerOut = z.output<typeof scUpdatePeer>
...
export const getLocaleFormSchema = (max: number) => {
  const obj: z.core.$ZodLooseShape = {}
...
export type LocaleForm = { [x: string]: any }
